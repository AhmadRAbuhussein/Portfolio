        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              I'm <b className="purple">Ahmad Abuhussein</b>, a full-stack software engineer passionate about building scalable web and mobile applications.
              <br />
              <br />
              I specialize in technologies like{" "}
              <i>
                <b className="purple">C#, .NET Core, React, React Native, TypeScript, and PostgreSQL</b>
              </i>
          ...
          <Col md={12} className="home-about-social">
            ...
            <ul className="home-about-social-links">
              <li className="social-icons">
                <a
                  href="https://github.com/AhmadRAbuhussein"
                  target="_blank"
                  rel="noreferrer"
              ...
              <li className="social-icons">
                <a
                  href="https://www.linkedin.com/in/ahmad-abu-hussein-383996182/"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                >
              ...
              <li className="social-icons">
                <a
                  href="https://www.instagram.com/ahmad_abuhusseinn/"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour home-social-icons"
                >
